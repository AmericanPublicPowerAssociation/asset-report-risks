...
exports.sortRisks = exports.setRisks = exports.clearSuggestions = exports.setProductVersionSuggestions = exports.setProductNameSuggestions = exports.setVendorNameSuggestions = exports.refreshRisks = exports.suggestProductVersions = exports.suggestProductNames = exports.suggestVendorNames = exports.logError = void 0;
...
var suggestVendorNames = function suggestVendorNames(payload) {
  return {
    payload: payload,
    type: _constants.SUGGEST_VENDOR_NAMES
  };
};

exports.suggestVendorNames = suggestVendorNames;

var suggestProductNames = function suggestProductNames(payload) {
  return {
    payload: payload,
    type: _constants.SUGGEST_PRODUCT_NAMES
  };
};

exports.suggestProductNames = suggestProductNames;

var suggestProductVersions = function suggestProductVersions(payload) {
  return {
    payload: payload,
    type: _constants.SUGGEST_PRODUCT_VERSIONS
  };
};

exports.suggestProductVersions = suggestProductVersions;
...
var setVendorNameSuggestions = function setVendorNameSuggestions(payload) {
  return {
    payload: payload,
    type: _constants.SET_VENDOR_NAME_SUGGESTIONS
  };
};
...
var setProductNameSuggestions = function setProductNameSuggestions(payload) {
  return {
    payload: payload,
    type: _constants.SET_PRODUCT_NAME_SUGGESTIONS
  };
};
...
var setProductVersionSuggestions = function setProductVersionSuggestions(payload) {
  return {
    payload: payload,
    type: _constants.SET_PRODUCT_VERSION_SUGGESTIONS
  };
};

exports.setProductVersionSuggestions = setProductVersionSuggestions;

var clearSuggestions = function clearSuggestions(payload) {
  return {
    payload: payload,
    type: _constants.CLEAR_SUGGESTIONS
  };
};
...
var sortRisks = function sortRisks(payload) {
  return {
    payload: payload,
    type: _constants.SET_SORTED_RISKS
  };
};
...
function EnhancedInput(props) {
  ...
  function handleStateChange(changes) {
    var attribute = props.attribute,
        ...
        trackChange = props.trackChange;

    if (changes.hasOwnProperty('selectedItem')) {
      var _value = changes.selectedItem;
      saveChange(attribute, _value);
    } else if (changes.type === _downshift["default"].stateChangeTypes.changeInput) {
      var _value2 = changes.inputValue;
      trackChange(attribute, _value2);
      onSuggest(_value2);
    } else if (changes.isOpen === false) {
      var _value3 = props.value;
      saveChange(attribute, _value3);
    }
  }

  function saveChange(attribute, value) {
    var clearSuggestions = props.clearSuggestions,
...
var _EnhancedInput = _interopRequireDefault(require("./EnhancedInput"));
...
function ProductName(props) {
  var _this$props = this.props,
      ...
      TextFieldProps = _this$props.TextFieldProps,
      trackChange = _this$props.trackChange,
      saveChange = _this$props.saveChange;
  var dispatch = (0, _reactRedux.useDispatch)();
  var productNameSuggestions = (0, _reactRedux.useSelector)(_selectors.getProductNameSuggestions);
  return _react["default"].createElement(_EnhancedInput["default"], {
    className: className,
    disabled: disabled,
    label: "Product Name",
    ...
    onSuggest: function onSuggest(value) {
      return dispatch((0, _actions.suggestProductNames)({
        typeCode: typeCode,
    ...
    clearSuggestions: function clearSuggestions() {
      return dispatch(_actions.clearSuggestions);
    },
...
exports["default"] = ProductVersion;
...
function ProductVersion(props) {
  var _this$props = this.props,
      ...
      vendorName = _this$props.vendorName,
      productName = _this$props.productName,
      productVersion = _this$props.productVersion,
      TextFieldProps = _this$props.TextFieldProps,
      trackChange = _this$props.trackChange,
      saveChange = _this$props.saveChange;
  var dispatch = (0, _reactRedux.useDispatch)();
  var productVersionSuggestions = (0, _reactRedux.useSelector)(_selectors.getProductVersionSuggestions);
  return _react["default"].createElement(_EnhancedInput["default"], {
    className: className,
    disabled: disabled,
    ...
    TextFieldProps: TextFieldProps,
    onSuggest: function onSuggest(value) {
      return (0, _actions.suggestProductVersions)({
        typeCode: typeCode,
        vendorName: vendorName,
...
function (_PureComponent) {
  _inherits(_RisksCardWithoutStyles, _PureComponent);
  ...
  _createClass(_RisksCardWithoutStyles, [{
    ...
    value: function render() {
      ...
      }, _react["default"].createElement(_TableBody["default"], null, _react["default"].createElement(_TableRow["default"], null, _ref, _react["default"].createElement(_TableCell["default"], {
        align: "right"
      }, aggregatedThreatScore)), _react["default"].createElement(_TableRow["default"], null, _ref2, _react["default"].createElement(_TableCell["default"], {
        align: "right"
      }, riskCount)), _react["default"].createElement(_TableRow["default"], null, _ref3, _react["default"].createElement(_TableCell["default"], {
        align: "right"
...
var tableIcons = {
  ...
  SortArrow: (0, _react.forwardRef)(function (props, ref) {
    return _react["default"].createElement(_ArrowDownward["default"], _extends({}, props, {
      ref: ref
    }));
  }),
...
var RISK_TABLE_COLUMN_NAMES = ['name', 'meter Count', 'aggregated threat', 'vulnerability', 'published', 'status'];

function RisksTable(props) {
  var tableName = 'Risks';
  var columns = RISK_TABLE_COLUMN_NAMES.map(function (field) {
    return {
      field: field,
      title: getHeaderLabel(field)
    };
  });
  var data = (0, _reactRedux.useSelector)(_selectors.getRisks);
  ...
  return _react["default"].createElement(_materialTable["default"], {
    icons: tableIcons,
    title: tableName,
    options: {
      search: true
...
function VendorName(props) {
  var _this$props = this.props,
      ...
      saveChange = _this$props.saveChange;
  var dispatch = (0, _reactRedux.useDispatch)();
  var vendorNameSuggestions = (0, _reactRedux.useSelector)(_selectors.getVendorNameSuggestions);
  return _react["default"].createElement(_EnhancedInput["default"], {
    className: className,
    disabled: disabled,
    label: "Vendor Name",
    ...
    TextFieldProps: TextFieldProps,
    onSuggest: function onSuggest(value) {
      return dispatch((0, _actions.suggestVendorNames)({
        typeCode: typeCode,
        vendorName: value
      }));
    },
    clearSuggestions: function clearSuggestions() {
      return dispatch((0, _actions.clearSuggestions)());
    },
    saveChange: saveChange,
    trackChange: trackChange
  });
...
var _EnhancedInput = require("./EnhancedInput");

Object.keys(_EnhancedInput).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _EnhancedInput[key];
    }
  });
});

var _ProductName = require("./ProductName");

Object.keys(_ProductName).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _ProductName[key];
    }
  });
});
...
Object.keys(_ProductVersion).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _ProductVersion[key];
    }
  });
});

var _RisksTable = require("./RisksTable");

Object.keys(_RisksTable).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _RisksTable[key];
    }
  });
});

var _VendorName = require("./VendorName");

Object.keys(_VendorName).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _VendorName[key];
    }
  });
});
"use strict";
...
exports.SET_SORTED_RISKS = exports.SET_RISKS = exports.SET_TASK = exports.CLEAR_SUGGESTIONS = exports.SET_PRODUCT_VERSION_SUGGESTIONS = exports.SET_PRODUCT_NAME_SUGGESTIONS = exports.SET_VENDOR_NAME_SUGGESTIONS = exports.REFRESH_RISK_METRICS = exports.REFRESH_RISKS = exports.SUGGEST_PRODUCT_VERSIONS = exports.SUGGEST_PRODUCT_NAMES = exports.SUGGEST_VENDOR_NAMES = exports.LOG_ERROR = void 0;
...
exports.sortedRisks = exports.risks = exports.productVersionSuggestions = exports.productNameSuggestions = exports.vendorNameSuggestions = void 0;
...
var vendorNameSuggestions = function vendorNameSuggestions() {
  ...
  switch (action.type) {
    case _constants.SET_VENDOR_NAME_SUGGESTIONS:
      {
        var vendorNames = action.payload;
        return vendorNames;
      }
...
var productNameSuggestions = function productNameSuggestions() {
  ...
  switch (action.type) {
    case _constants.SET_PRODUCT_NAME_SUGGESTIONS:
      {
        var productNames = action.payload;
        return productNames;
      }
...
var productVersionSuggestions = function productVersionSuggestions() {
  ...
  switch (action.type) {
    case _constants.SET_PRODUCT_VERSION_SUGGESTIONS:
      {
        var productVersions = action.payload;
        return productVersions;
      }
...
var risks = function risks() {
  ...
  switch (action.type) {
    case _constants.SET_SORTED_RISKS:
    case _constants.SET_RISKS:
      {
        var _risks = action.payload.risks;
        return _risks;
      }

    case _constants.SET_TASK:
      {
        var task = action.payload;
        var taskAssetId = task.assetId;
        var taskReferenceUri = task.referenceUri;
    ...
    case _constants.SET_SORTED_RISKS:
      {
        var _action$payload = action.payload,
            sortKey = _action$payload.sortKey,
  ...
  return regeneratorRuntime.wrap(function watchSuggestVendorNames$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return (0, _effects.takeLatest)(_constants.SUGGEST_VENDOR_NAMES,
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee(action) {
            var _action$payload, typeCode, vendorName, url, params;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 4;
                    return (0, _effects.put)((0, _actions.clearSuggestions)());
                        ...
                        return regeneratorRuntime.wrap(function on200$(_context) {
                          while (1) {
                            switch (_context.prev = _context.next) {
                              case 0:
                                _context.next = 2;
                                return (0, _effects.put)((0, _actions.setVendorNameSuggestions)(vendorNames));
  ...
  return regeneratorRuntime.wrap(function watchSuggestProductNames$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return (0, _effects.takeLatest)(_constants.SUGGEST_PRODUCT_NAMES,
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee2(action) {
            var _action$payload2, typeCode, vendorName, productName, url, params;
                        ...
                        return regeneratorRuntime.wrap(function on200$(_context4) {
                          while (1) {
                            switch (_context4.prev = _context4.next) {
                              case 0:
                                _context4.next = 2;
                                return (0, _effects.put)((0, _actions.setProductNameSuggestions)(productNames));
  ...
  return regeneratorRuntime.wrap(function watchSuggestProductVersions$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          _context9.next = 2;
          return (0, _effects.takeLatest)(_constants.SUGGEST_PRODUCT_VERSIONS,
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee3(action) {
            var _action$payload3, typeCode, vendorName, productName, productVersion, url, params;
                        ...
                        return regeneratorRuntime.wrap(function on200$(_context7) {
                          while (1) {
                            switch (_context7.prev = _context7.next) {
                              case 0:
                                _context7.next = 2;
                                return (0, _effects.put)((0, _actions.setProductVersionSuggestions)(productVersions));
  ...
  return regeneratorRuntime.wrap(function watchRefreshRisks$(_context13) {
    while (1) {
      switch (_context13.prev = _context13.next) {
        case 0:
          _context13.next = 2;
          return (0, _effects.takeLatest)(_constants.REFRESH_RISKS,
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee4(action) {
            var payload, sortKey, order, url, params;
            return regeneratorRuntime.wrap(function _callee4$(_context12) {
                        ...
                        return regeneratorRuntime.wrap(function on200$(_context10) {
                          while (1) {
                            switch (_context10.prev = _context10.next) {
                              case 0:
                                _context10.next = 2;
                                return (0, _effects.put)((0, _actions.setRisks)(risks));
                          ...
                          while (1) {
                            switch (_context11.prev = _context11.next) {
                              case 0:
                                ...
                                _context11.next = 3;
                                return (0, _effects.put)((0, _actions.sortRisks)(payload));
  ...
  return regeneratorRuntime.wrap(function fetchSafely$(_context14) {
    while (1) {
      switch (_context14.prev = _context14.next) {
        ...
        case 24:
          _context14.next = 26;
          return (0, _effects.put)((0, _actions.logError)({
            status: status
          }));
